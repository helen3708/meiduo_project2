...
SECRET_KEY = 'jn6!jsuiecoca2z+iq)*uo&chkheygkf8anyc282ozws=o6f)l'
...
SINA_REDIRECT_URL = 'http://www.meiduo.site/sina_callback/'
...
FDFS_BASE_URL = 'http://192.168.159.137:8888/'  # FastDFS中sotrage(nginx) ip和端口

# Haystack
HAYSTACK_CONNECTIONS = {
    'default': {
        'ENGINE': 'haystack.backends.elasticsearch_backend.ElasticsearchSearchEngine',
        'URL': 'http://192.168.159.137:9200/', # Elasticsearch服务器ip地址，端口号固定为9200
        'INDEX_NAME': 'meiduo_mall2', # Elasticsearch建立的索引库的名称
    },
}
